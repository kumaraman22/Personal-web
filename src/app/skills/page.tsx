  ...
  return (
    ...
    <div className="h-full w-full relative flex flex-col items-start gap-5 overflow-hidden">
      ...
      <div className="flex flex-col gap-3">
        <Heading>Core competency</Heading>
        <FramerWrapper y={0} x={200}>
          <p className="font-poppins text-xl w-full text-primary max-sm:text-lg">
            I am a final year B-Tech Student & I have a good proficiency over HTML5,
            CSS3, JS, TS and React, including responsive design principles. I
            specialized in building web applications and sites using MERN, which
            can provide value to the users.
          </p>
        </FramerWrapper>
